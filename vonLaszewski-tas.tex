...
We present our results in a number of graphs and tables. However we provide first some data related to the sample.
...
\begin{figure*}[htb] 
  ...
  \caption{Percentile ranging by FOS in a stacked barchart.}\label{F:xsede-stacked} 
\end{figure*}
...
peers'. {\em It shows XSEDE publications tend to have higher percentile
ranking.}
...
\begin{tabular}{lrrrrrr}
 ...
 & Publications & Rank & Rank & Citations & Citations \\
\hline
XD & 2349	& 61	& 65	& 26	& 11 \\
...
We can perform a T-test to show the statistic significance. The results
...
We furthermore aggregate the results based on their parents FOS, and finally to the top level FOS category, as defined by NSF. The results (chart and raw data) are shown as below.
